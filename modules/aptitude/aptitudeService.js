...
export async function submitAptitudeAttempt({ userId, userEmail, quizConfig, score, totalQuestions, userAnswers }) {
  try {
    ...
    console.error("Error submitting aptitude attempt:", err);
    throw err;
  }
}
