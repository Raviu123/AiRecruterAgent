    ...
    <div className='mt-5 '>
        ...
        {candidateList?.map((candidate,index)=>(
            ...
            <div className="flex items-center gap-5">
              <h2 className="">{user&&<Image src={user?.picture} alt="userpic" width={40} height={40} className='mr-4 rounded-full'></Image>} </h2>
                <div>
                  <h2 className="font-bold">{candidate?.userName[0]}</h2>
